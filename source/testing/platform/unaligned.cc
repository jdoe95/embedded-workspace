...
TEST(Unaligned, U16DeathTest)
{
	...
	EXPECT_DEATH(unalign_u16((uint16_t) 0, nullptr), TESTING_DEATH_STRING);
}
...
#	if CONFIG_ENDIANNESS == ENDIAN_BIG
	EXPECT_EQ(align_u16(data), (uint16_t)0xAABB);

#	elif CONFIG_ENDIANNESS == ENDIAN_LITTLE
	EXPECT_EQ(align_u16(data), (uint16_t)0xBBAA);
...
TEST(Unaligned, UnalignU16)
{
	...
	unalign_u16((uint16_t)0xAABB, data);
...
TEST(Unaligned, U32DeathTest)
{
	...
	EXPECT_DEATH(unalign_u32((uint32_t) 0, nullptr), TESTING_DEATH_STRING);
}
...
#	if CONFIG_ENDIANNESS == ENDIAN_BIG
	EXPECT_EQ(align_u32(data), (uint32_t)0xAABBCCDD);

#	elif CONFIG_ENDIANNESS == ENDIAN_LITTLE
	EXPECT_EQ(align_u32(data), (uint32_t)0xDDCCBBAA);
...
TEST(Unaligned, UnalignU32)
{
	...
	unalign_u32((uint32_t)0xAABBCCDD, data);
...
TEST(Unaligned, U64DeathTest)
{
	...
	EXPECT_DEATH(unalign_u64((uint64_t) 0, nullptr), TESTING_DEATH_STRING);
}
...
#	if CONFIG_ENDIANNESS == ENDIAN_BIG
	EXPECT_EQ(align_u64(data), (uint64_t)0xAABBCCDD11223344);

#	elif CONFIG_ENDIANNESS == ENDIAN_LITTLE
	EXPECT_EQ(align_u64(data), (uint64_t)0x44332211DDCCBBAA);
...
TEST(Unaligned, UnalignU64)
{
	...
	unalign_u64((uint64_t)0xAABBCCDD11223344, data);
